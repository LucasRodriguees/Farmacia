...
public class ProdutoController {
	...
	@GetMapping("/entre/{preco}/{preco1}")
	public ResponseEntity<List<Produto>> findByEntre(@PathVariable BigDecimal preco, @PathVariable BigDecimal preco1) {
		return ResponseEntity.ok(repository.findAllByPrecoBetweenOrderByPreco(preco, preco1));
	}
